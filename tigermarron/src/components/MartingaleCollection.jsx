...
import ProductCard from "../components/products/MproductCard";
import productsData from "../components/data/martingaleproducts";
import "./MartingaleCollection.css";


const MartingaleCollection = () => {
...
export default MartingaleCollection;
