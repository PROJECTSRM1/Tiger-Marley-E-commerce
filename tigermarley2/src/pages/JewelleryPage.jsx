...
import SideBarJewellery from "../components/filters/SideBarJewellery";
import JProductCard from "../components/products/JproductCard";
import productsData from "../components/data/jewelleryproducts";
import "./BeltPage.css";
import JproductCard from "./products/JproductCard";
    ...
    <div className="full-page-container">
      ...
      <div className="home-layout">
        ...
        <aside className="sidebar-section">
          <SideBarJewellery filters={filters} setFilters={setFilters} />
        </aside>
        ...
        <main className="main-section">
          ...
          >
            {sortedProducts.length > 0 ? (
              sortedProducts.map((p) => <JproductCard key={p.id} product={p} />)
            ) : (
