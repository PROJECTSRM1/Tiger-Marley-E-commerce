...
import SideBarKey from "../components/filters/SideBarKey";
import ProductCard from "../components/products/ProductCard";
import productsData from "../components/data/keyproducts";
import "./BeltPage.css";
    ...
    <div className="full-page-container">
      ...
      <div className="home-layout">
        ...
        <aside className="sidebar-section">
          <SideBarKey filters={filters} setFilters={setFilters} />
        </aside>
