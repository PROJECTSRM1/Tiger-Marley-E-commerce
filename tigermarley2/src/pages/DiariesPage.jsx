...
import SideBarDiary from "../components/filters/SideBarDiary";
import DiaryProductCard from "../components/products/DiaryProductCard";
import productsData from "../components/data/diaryproducts";
import "./BeltPage.css";
// import SideBarDiary from "../components/filters/SideBarDiary";
    ...
    <div className="full-page-container">
      ...
      <div className="home-layout">
        ...
        <aside className="sidebar-section">
          <SideBarDiary filters={filters} setFilters={setFilters} />
        </aside>
        ...
        <main className="main-section">
          ...
          >
            {sortedProducts.length > 0 ? (
              sortedProducts.map((p) => <DiaryProductCard key={p.id} product={p} />)
            ) : (
