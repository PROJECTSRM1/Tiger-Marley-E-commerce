...
import SideBarCharms from "../components/filters/SideBarCharms";
import CharmsProductCard from "../components/products/CharmsProductCard";
import productsData from "../components/data/charmsproducts";
import "./BeltPage.css";
    ...
    <div className="full-page-container">
      ...
      <div className="home-layout">
        ...
        <aside className="sidebar-section">
          <SideBarCharms filters={filters} setFilters={setFilters} />
        </aside>
        ...
        <main className="main-section">
          ...
          >
            {sortedProducts.length > 0 ? (
              sortedProducts.map((p) => <CharmsProductCard key={p.id} product={p} />)
            ) : (
