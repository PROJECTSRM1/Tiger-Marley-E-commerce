...
import ProductCard from "../components/products/PassproductCard";
import productsData from "../components/data/passportproducts";
import "./PassportHolderPage.css";

const PassportHolderPage= () => {
    ...
    <div className="home-layout">
      ...
      <main className="main-section">
        ...
        <div className="top-controls">
          <h2 className="collection-title">PASSPORT HOLDER</h2>
...
export default PassportHolderPage;
